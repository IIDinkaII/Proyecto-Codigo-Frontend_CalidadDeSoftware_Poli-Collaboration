...
const SignUp = () => {
  ...
  const SignUpSchema = Yup.object().shape({
    ...
    passwordConfirmation: Yup.string().required('Campo obligatorio')
      ...
      <Flex px={'10%'} pt={'5%'} pb={'15%'}>
        <Box shadow="md" background="white" borderWidth="1px" width="100%" borderRadius="lg">
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            {/* Correo */}
            <FormControl px={10} py={2} mt={2} id="correoInstitucional"
            ...
            <HStack px={10}>
              <Text width="50%" fontSize="xs" color="red.500">{formik.errors.sexo}</Text>
              <Text width="50%" fontSize="xs" color="red.500">{formik.errors.fechaNacimiento}</Text>
            </HStack>
            ...
            <HStack px={10}>
              <Text width="50%" fontSize="xs" color="red.500">{formik.errors.password}</Text>
              <Text width="50%" fontSize="xs" color="red.500">{formik.errors.passwordConfirmation}</Text>
            </HStack>
